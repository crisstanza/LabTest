...
var _Player_instances, _Player_table, _Player_i, _Player_j, _Player_showPlayer, _Player_removePlayer, _Player_isFlip, _Player_flipPlayer, _Player_canMoveToUp, _Player_canMoveToRight, _Player_canMoveToDown, _Player_canMoveToLeft, _Player_hasTopWall, _Player_hasRightWall, _Player_hasBottomWall, _Player_hasLeftWall, _Player_hasBelowTopWall, _Player_hasPreviousRightWall, _Player_hasAboveBottomWall, _Player_hasNextLeftWall, _Player_isInFirstRow, _Player_isInLastRow, _Player_isInFirstColumn, _Player_isInLastColumn, _Player_refreshPlayer;
...
export class Player {
    ...
    moveUp() {
        if (__classPrivateFieldGet(this, _Player_instances, "m", _Player_canMoveToUp).call(this)) {
            __classPrivateFieldGet(this, _Player_instances, "m", _Player_refreshPlayer).call(this, () => { var _a, _b; return __classPrivateFieldSet(this, _Player_i, (_b = __classPrivateFieldGet(this, _Player_i, "f"), _a = _b--, _b), "f"), _a; });
        }
    }
    moveRight() {
        if (__classPrivateFieldGet(this, _Player_instances, "m", _Player_canMoveToRight).call(this)) {
            __classPrivateFieldGet(this, _Player_instances, "m", _Player_refreshPlayer).call(this, () => { var _a, _b; return __classPrivateFieldSet(this, _Player_j, (_b = __classPrivateFieldGet(this, _Player_j, "f"), _a = _b++, _b), "f"), _a; });
        }
    }
    moveLeft() {
...
_Player_table = new WeakMap(), _Player_i = new WeakMap(), _Player_j = new WeakMap(), _Player_instances = new WeakSet(), _Player_showPlayer = function _Player_showPlayer() {
    __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.add(CssClasses.PLAYER);
}, _Player_removePlayer = function _Player_removePlayer(isFlip) {
    __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.remove(CssClasses.PLAYER);
    if (isFlip) {
        __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.remove(CssClasses.FLIP);
    }
}, _Player_isFlip = function _Player_isFlip() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.FLIP);
}, _Player_flipPlayer = function _Player_flipPlayer() {
    __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.add(CssClasses.FLIP);
    ...
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.TOP);
}, _Player_hasRightWall = function _Player_hasRightWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.RIGHT);
}, _Player_hasBottomWall = function _Player_hasBottomWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.BOTTOM);
}, _Player_hasLeftWall = function _Player_hasLeftWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.LEFT);
}, _Player_hasBelowTopWall = function _Player_hasBelowTopWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f") + 1].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.TOP);
}, _Player_hasPreviousRightWall = function _Player_hasPreviousRightWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f") - 1].classList.contains(CssClasses.RIGHT);
}, _Player_hasAboveBottomWall = function _Player_hasAboveBottomWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f") - 1].cells[__classPrivateFieldGet(this, _Player_j, "f")].classList.contains(CssClasses.BOTTOM);
}, _Player_hasNextLeftWall = function _Player_hasNextLeftWall() {
    return __classPrivateFieldGet(this, _Player_table, "f").rows[__classPrivateFieldGet(this, _Player_i, "f")].cells[__classPrivateFieldGet(this, _Player_j, "f") + 1].classList.contains(CssClasses.LEFT);
